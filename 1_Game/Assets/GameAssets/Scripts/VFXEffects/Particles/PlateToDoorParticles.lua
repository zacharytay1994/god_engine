-- Creates a trail of sparkly bubbles to indicate that a pressure plate has opened a door.

--[IsComponent]
function C_PlateDoorParticleSystem()
    local var = {
        --[SerializeFloat]
        emissionRate = 1.0,
...
--[IsSystem]
function S_PlateToDoorParticleSystem(e)
    local dt = GetDeltaTime()
    local trailEmitter = GetComponent(e, "C_PlateDoorParticleSystem")
